 ...
 * browserify -r ./eml-format.js:eml-format  > eml-format.bundle.js
 * var emlformat = require('eml-format');
 * emlformat.read(string_or_object_eml, function(error, data) {});
 ******************************************************************************************/
...
},{}],"eml-format":[function(require,module,exports){
(function (Buffer){
/******************************************************************************************
...
var emlformat = {
  ...
  getEmailAddress: function(raw) {
    ...
    if (match) {
      var name = emlformat.unquoteUTF8(match[1]).replace(/"/g, "").trim();
      if (name && name.length) {
        result.name = name;
      }
  ...
  unquotePrintable: function(s) {
    ...
    return s
    .replace(/=([\w\d]{2})=([\w\d]{2})=([\w\d]{2})/gi, function(matcher, p1, p2, p3, offset, string) { return new Buffer([ parseInt(p1, 16), parseInt(p2, 16), parseInt(p3, 16) ]).toString("utf8"); })
    .replace(/=([\w\d]{2})=([\w\d]{2})/gi, function(matcher, p1, p2, offset, string) { return new Buffer([ parseInt(p1, 16), parseInt(p2, 16) ]).toString("utf8"); })
